...
import { SafeAreaView, View, TouchableOpacity, TextInput, AsyncStorage, StyleSheet, Text } from 'react-native';
...
export default class NewTweet extends Component {
  ...
  handleTweet = async() => {
    ...
    const author = await AsyncStorage.getItem('@TwitterUser:username');
